...
class ClientWorkspace {
    ...
    start(context) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.disposables.push(vscode_1.languages.registerSignatureHelpProvider({ language: 'rust' }, new signatureHelpProvider_1.SignatureHelpProvider(this.lc), '(', ','));
        });
    }
    stop() {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    registerCommands(context) {
        ...
        const findImplsDisposable = vscode_1.commands.registerTextEditorCommand('rls.findImpls', (textEditor, _edit) => __awaiter(this, void 0, void 0, function* () {
            if (!this.lc) {
                return;
            }
            ...
            const request = useLSPRequest
                ? vscode_languageclient_1.ImplementationRequest.type.method
                : 'rustDocument/implementations';
            const params = this.lc.code2ProtocolConverter.asTextDocumentPositionParams(textEditor.document, textEditor.selection.active);
            let locations;
            try {
                locations = yield this.lc.sendRequest(request, params);
            }
            catch (reason) {
                vscode_1.window.showWarningMessage(`find implementations failed: ${reason}`);
                return;
            }
            return vscode_1.commands.executeCommand('editor.action.showReferences', textEditor.document.uri, textEditor.selection.active, locations.map(this.lc.protocol2CodeConverter.asLocation));
        }));
        ...
        this.disposables.push(vscode_1.commands.registerCommand('rls.run', (cmd) => tasks_1.runCargoCommand(this.folder, cmd)));
    }
    ...
    getSysroot(env) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const rustcPrintSysroot = () => this.config.rustupDisabled
                ...
                : wslWrapper.execFile(this.config.rustupPath, ['run', this.config.channel, 'rustc', '--print', 'sysroot'], { env });
    ...
    makeRlsProcess() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.config.rustupDisabled) {
                ...
                const env = yield makeRlsEnv();
                childProcess = child_process_1.withWsl(config.useWSL).spawn(config.path, ['run', config.channel, rlsPath], { env, cwd });
            }
...
function warnOnMissingCargoToml() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (files.length < 1) {
            vscode_1.window.showWarningMessage('A Cargo.toml file must be at the root of the workspace in order to support all features');
        }
    });
}
/**
